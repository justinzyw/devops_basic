...
#It is possible that after updating the daemon.json file, restart fails. Then need to update /lib/systemd/system/docker.service by changing the ExecStart line to ExecStart=/usr/bin/dockerd
